...
#' @description Compute 24 measures describing the Features of the Trajectories. See details for the list of measures.
...
#' @param Time A \emph{n} by \emph{m} matrix or data frame containing the  measurement times corresponding to the values of the \code{Data} data frame. See details.
