...
#' @description Classify trajectories based on the factors identified in \code{step2factors}.
#' @param trajFactors Object generated by \code{step2factors}. Contains
...
#'
#' @return \code{traj} object that contains objects carried through steps 1 and 2 which includes the original data, measures and factors.
#' 
...
#'
#' @details If \code{nclusters} is set to \code{NULL}, the function will use the
#'\code{\link[NbClust]{NbClust}} function to select the
#'optimal number of clusters. The \code{NbClust} function
#'uses \code{kmeans} as the cluster analysis method. The criteria
...
#'run multiple times. Increassing \code{nstart} will generaly stabilize the results.
#'
