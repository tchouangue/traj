...
Data consist in two dataframes. The first dataframe, $\texttt{example.data\$data}$, contains the values for each individual trajectory. Each row correspond to a trajectory.
